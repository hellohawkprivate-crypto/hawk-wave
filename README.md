...
### v0.4.0 — 2026-04-09 · Goldvein War Prep アプリ

- イベント準備用アプリ「Goldvein War Prep」7ページ構築
- 全ページ6言語対応（ja / en / ko / zh-TW / zh-CN / ar）
- 戦力分析（フィルタ・ヒストグラム）・占領時間シミュレーター
- Google Sheets連携（戦略シート・戦力データ）
- ドラクエ風ログインページ

→ [リリース詳細](docs/releases/v0.4.0-goldvein-prep.md)
...
- **next-intl** — 多言語対応（ja / en / ko / zh-TW / zh-CN / ar）
- **Recharts** — データ可視化（ヒストグラム）
