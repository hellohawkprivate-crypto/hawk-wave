...
const ja: RulesContent = {
  ...
  victoryTitle: '勝利条件',
  victoryDesc: '4W終了後に、攻撃側の「破壊値」が5,001 Ptを超えていたら攻撃側の勝利、下回ったら防衛側の勝利。',
  ...
  carryoverItems: [
    ...
    '2W終了後の進行度・破壊状態は3Wに引き継がれる',
    '3W終了後の進行度・破壊状態は4Wに引き継がれる',
  ...
  defenseBuffs: [
    ...
    { condition: '3W開始前の破壊値 > 1,010', effect: '爆弾解除速度 +7.5%、兵士戦死率 -15%' },
    { condition: '3W開始前の破壊値 > 1,250', effect: '爆弾解除速度 +7.5%' },
    { condition: '4W開始前の破壊値 > 1,840', effect: '兵士戦死率 -5%' },
    { condition: '4W開始前の破壊値 > 3,500', effect: '爆弾解除速度 +7.5%、兵士戦死率 -15%' },
  ],
  attackBuffs: [
    { condition: 'デフォルト', effect: '爆弾設置速度 +30%' },
    { condition: '3W開始前の破壊値 < 260', effect: '爆弾設置速度 +7.5%、行軍速度 +10%' },
    { condition: '3W開始前の破壊値 < 500', effect: '爆弾設置速度 +7.5%、兵士戦死率 -15%' },
    { condition: '4W開始前の破壊値 < 1,740', effect: '爆弾設置速度 +7.5%、兵士戦死率 -15%' },
    { condition: '4W開始前の破壊値 < 4,660', effect: '兵士戦死率 -5%' },
  ],
}
