...
**日付**: 2026-04-09  
**ステータス**: ⚠️ Superseded — 633-portal `docs/adr/0001-single-deploy-slug-routing.md` により覆された（2026-07-29）

> ここで採用した「案B: イベントごとに別 Vercel プロジェクト」は後継の 633-portal では採らず、
> 却下されていた「案A: 単一デプロイ・slug 分岐」を実装している。経緯は上記 ADR を参照。
